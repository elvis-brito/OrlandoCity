...
<head>
    ...
    <script src="https://kit.fontawesome.com/d880a3c0fd.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <header>
        ...
        <div id="menu-mobile-mask" class="d-block d-sm-none">
        ...
        <div class="header-black">
            ...
            <div class="container">
                ...
                <input id="input-search-mobile" type="search" class="d-block d-sm-none" placeholder="seach...">
